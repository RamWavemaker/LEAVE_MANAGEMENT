...
@WebServlet("/rejectedleaves")
public class GetRejectedLeavesServlet extends HttpServlet {
    private LeaveService leaveService;
    private static final Logger logger = LoggerFactory.getLogger(GetRejectedLeavesServlet.class);
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        Leaves.Status status = Leaves.Status.REJECTED;
